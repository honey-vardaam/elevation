...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::prefix('projects/{project}')->name('projects.')->scopeBindings()->group(function () {
        Route::get('activity', [ProjectActivityController::class, 'index'])->name('activity');
        ...
        Route::get('files/{file}/view', [ProjectFileController::class, 'view'])->name('files.view');
        ...
        Route::get('phases/{phase}', [ProjectPhaseController::class, 'show'])->name('phases.show');
        ...
        Route::delete('phases/{phase}/activities/{activity}', [PhaseActivityController::class, 'destroy'])->name('phases.activities.destroy');
